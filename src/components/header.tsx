...
const SiteHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/80 dark:bg-black/80 backdrop-blur-sm transition-all duration-300 hover:bg-white/90 dark:hover:bg-black/90">
